...
import { bulkUpload, createWordmanagement, deleteWordmanagement, getAllWordmanagements, getWordmanagementById, updateWordmanagement } from "./wordmanagement.controller";
...
//: bulk upload
router.post("/bulk-upload", authGuard, permission(["admin"]), uploadSingle("file"), bulkUpload);
